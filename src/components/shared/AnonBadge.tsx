type ColorResult = { bg: string; text: string; dot: string };

/** Deterministic color from an opaque anon token. Pure function — no user data. */
function hashColor(token: string): ColorResult {
    let h = 0;
